---
title: Agent 框架档案
description: 主流 Agent 框架的技术档案，聚焦架构差异与设计权衡。
---
...
- :material-account-multiple: **[AutoGen](autogen.md)**

    ---

    Microsoft · Python · 多 Agent 对话框架

- :material-account-group: **[CrewAI](crewai.md)**
...
- :material-microsoft: **[Semantic Kernel](semantic-kernel.md)**
    ...
    Microsoft · C#/Python/Java · 企业级 AI 编排
...
- :material-robot-outline: **[Coze](coze.md)**
